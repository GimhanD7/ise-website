            ...
            >
              {i % 2 === 0 ? (
                <>
                  ...
                  <stop offset="20%" stopColor="#010b60" stopOpacity="0.8" />
                  <stop offset="80%" stopColor="#010b60" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#010b60" stopOpacity="0" />
                </>
              ) : (
                <>
                  <stop offset="0%" stopColor="#f46a0f" stopOpacity="0" />
                  <stop offset="20%" stopColor="#f46a0f" stopOpacity="0.8" />
                  <stop offset="80%" stopColor="#f46a0f" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#f46a0f" stopOpacity="0" />
                </>
              )}
            </linearGradient>
          ))}
...
export default function BackgroundBeamsDemo() {
  return (
    <div className="relative h-screen w-screen overflow-hidden bg-transparent z-0">
      <BackgroundBeams />
    </div>
  );
}
